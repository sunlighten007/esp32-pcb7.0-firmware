...
ACCESS_ID = 'AKIAVHGP5H6E5DHFEJEN'
ACCESS_KEY = 'BEJY1/EXAE7lgm6BD54j/AWZAfcMH0GRRPk/pKTr'
...
if  path.exists(binary_path):
    ...
    id_header = open('src/main.ino', 'r',encoding='utf-8')
    current_version = ""
    for line in id_header.readlines():
        if re.search('\sFIRMWARE_VERSION\s', line, re.I) and str(line).startswith("const"):
